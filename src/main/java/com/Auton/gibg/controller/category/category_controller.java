...
//    @GetMapping("/parentById/{parentId}")
//    public ResponseEntity<ResponseWrapper<List<category_entity>>> getCategoriesByParentId(@PathVariable long parentId,
//                                                                                          @RequestHeader("Authorization") String authorizationHeader) {
//        try {
//            // Validate authorization using authService
//            ResponseEntity<ResponseWrapper<Void>> authResponse = authService.validateAuthorizationHeader(authorizationHeader);
...
//            List<category_entity> categories = categoryRepository.findByParentCategoryId(parentId);
//
//            if (!categories.isEmpty()) {
//                ResponseWrapper<List<category_entity>> responseWrapper = new ResponseWrapper<>("Categories found.", categories);
//                return ResponseEntity.ok(responseWrapper);
//            } else {
//                ResponseWrapper<List<category_entity>> responseWrapper = new ResponseWrapper<>("No categories found for the specified parent category ID.", null);
//                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(responseWrapper);
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//            ResponseWrapper<List<category_entity>> responseWrapper = new ResponseWrapper<>("An error occurred while fetching the categories", null);
//            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(responseWrapper);
//        }
//    }
